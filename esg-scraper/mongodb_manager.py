...
class MongoDBManager:
    ...
    def __init__(self, connection_string: str = None):
        ...
        self.connection_string = connection_string or os.getenv(
            "MONGODB_URI",
            "mongodb://localhost:27017/esg_scraper"
        )
    ...
    async def _create_indexes(self):
        ...
        try:
            ...
            await self.analyses.create_indexes([
                ...
                IndexModel([("company_name", ASCENDING), ("created_at", DESCENDING)]),
                IndexModel([("industry_sector", ASCENDING), ("overall_score", DESCENDING)]),
                IndexModel([("created_at", DESCENDING)]),
                IndexModel([("_id", ASCENDING), ("user_id", ASCENDING)])  # Compound for security
            ])
